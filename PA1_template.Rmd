...
On average, the `r AverageStepsByInterval[which.max(AverageStepsByInterval$steps),'interval',]` contains the highest amount of steps
...
activity_data_noNAs[is.na(activity_data$steps),1]=MedianStepsByInterval[which(AverageStepsByInterval$'interval' == activity_data[is.na(activity_data$steps),3]),2]
